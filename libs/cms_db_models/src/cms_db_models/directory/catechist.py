...
class Catechist(Base):
    ...
    id: Mapped[UUID] = mapped_column(primary_key=True, default=uuid7, server_default=func.uuidv7())
    code: Mapped[str] = mapped_column(String(20), nullable=False, unique=True) # should be GLV-INITIAL (for example: GLV-NQM)
